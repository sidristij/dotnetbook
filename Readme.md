...
Авторы делятся на четыре группы:
  ...
  - **Редакторы** - те, кто сделал обоснованные дополнения либо исправления уровня логики повествования (опечатки и орфография не в счет) в основной текст книги, проведя их через GitHub Pull Request;
