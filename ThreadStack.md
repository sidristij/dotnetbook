...
В данном коде не происходит ничего примечательного, однако не будем его пропускать. Когда `Method1` вызывает `Method2`, то любой вызов осуществляет следующие операции:
