...
catch (SomeException exception)
{
    ...
    {
        case ErrorCodes.NetworkDown:
            // ...
            break;
        case ErrorCodes.CacheDown:
            // ...
            break;
        default:
            throw;
...
catch (SomeException exception) when (exception.ErrorCode == ErrorCodes.NetworkDown)
{
    // ...
}
catch (SomeException exception) when (exception.ErrorCode == ErrorCodes.CacheDown)
{
    // ...
}
```

И вопрос улучшения тот вовсе не в отсутствии конструкции `switch`, которая, возможно отработала бы быстрее новой конструкции. Эта конструкция как по мне лучше по нескольким пунктам:
  ...
  - и менее явное, но также очень важное: предварительное сравнение идет ДО входа в catch блок. А это значит что работа такой конструкции будет идти намного быстрее.
