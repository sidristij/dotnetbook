...
namespace YetAnotherBank.FinancialPipe
{
    ...
    public class FinancialPipeException : Exception
    {
...
} catch (FinancialPipeException exception)
{
...
Как видите, выбор совсем не тривиален и требует подготовки. Причем именно с точки зрения архитектуры типов: ведь грамотная иерархия типов, их правиьлное расположение по пространствам имен, их правильный выброс и перехват гарантируют чистоту в архитектуре исключительных ситуаций.
...
public class CriticalCacheFault : NonRec*overableExceptionBase
{
