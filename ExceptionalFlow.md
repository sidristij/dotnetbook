...
Чего не хватает в языке прогаммирования C#, так это блока `fault`, суть которого - срабатывать всегда, когда произошла любая ошибка. Т.е. тот же `finally`, только на стероидах. Если бы такое было, мы бы смогли делать единую точку входа в логгирование исключительных ситуаций:
...
} catch (SomethException exception)
{
