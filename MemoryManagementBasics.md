...
Другой вопрос: зачем это может нам пригодиться? Ведь не просто же так при упаковке нам отдают именно object а не ссылку на экземпляр значимого типа в куче.
