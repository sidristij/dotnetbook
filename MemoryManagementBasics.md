...
Вторым примером я хочу показать вам что вобще понимается под "значением структуры является вся структура целиком"
